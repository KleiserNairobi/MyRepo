...
@Getter @Setter
@ApiModel(value = "Pessoa-Física-Cliente")
public class ClientePFDto {
    ...
    @ApiModelProperty(position = 5, required = true, example = "99999-999")
    ...
    @Size(min = 2, max = 2, message = "Estado deve ter {max} caracteres")
    ...
    @ApiModelProperty(position = 14, example = "-28.098883")
    private BigDecimal latitude;

    @ApiModelProperty(position = 15, example = "-048.675000")
