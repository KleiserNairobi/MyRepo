...
export default function Colaborador() {
  ...
  useEffect(() => {
    if (alterar) {
      history.push('/colaboradores-form');
    }
  }, [alterar, history])

  // Effect para carregamento dos colaboradores
  useEffect(() => {
    if (carregar) {
      setCarregando(true);
      service.obtem('/pessoas/colaboradores')
        .then(response => {
  ...
  return (
    <div>
      <CabecalhoForm
        ...
        subtitulo="Listagem de todos os colaboradores"
        linkPagina="/colaboradores-form"
