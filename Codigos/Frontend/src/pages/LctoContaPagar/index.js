...
export default function LctoContaPagar() {
  ...
  const colunasTabela = [
    ...
    { title: 'Fornecedor', field: 'pessoa.nome', cellStyle: {width: '300px', fontSize: 13} },
    ...
    { title: 'Vlr. Total', field: 'valorTotal', type: 'currency', cellStyle: {width: '120px', fontSize: 13},
      currencySetting: {
        locale: 'pt-BR', currencyCode:'BRL', 
        minimumFractionDigits: 2, maximumFractionDigits: 2
      }      
    },
    { title: 'Vlr. Pagar', field: 'valorPagar', type: 'currency', cellStyle: {width: '120px', fontSize: 13},
      currencySetting: {
        locale: 'pt-BR', currencyCode:'BRL', 
        minimumFractionDigits: 2, maximumFractionDigits: 2
      }       
  ...
  useEffect(() => {
    if (alterar) {
      history.push('/lctoContaPagar-form');
    }
  }, [alterar, history])
  ...
  return (
    <div>
      <CabecalhoForm
        ...
        subtitulo="Listagem de todas contas a pagar lançadas"
        linkPagina="/lctoContaPagar-form"
      ...
      <Card className={css.root}>
        <MyTable
          ...
          exportar={true}
          titulo="Lançamento de Contas a Pagar"
          apelido="LctoCtaPagar"
        />
      </Card>
      <ModalExclusao
