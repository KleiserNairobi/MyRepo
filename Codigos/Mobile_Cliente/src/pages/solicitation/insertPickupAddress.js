...
class InsertPickupAddressPage extends ValidationComponent {
  constructor(props) {
    super(props);
    this.errors = [];
    ...
    this.state = {
      ...
      pessoa: props.pessoa,
      cep: props.entrega.origem ? props.entrega.origem.cep : '',
      logradouro: props.entrega.origem ? props.entrega.origem.logradouro : '',
      numero: props.entrega.origem ? props.entrega.origem.numero : '',
      complemento: props.entrega.origem ? props.entrega.origem.complemento : '',
      bairro: props.entrega.origem ? props.entrega.origem.bairro : '',
      referencia: props.entrega.origem ? props.entrega.origem.referencia : '',
      cidade: props.entrega.origem ? props.entrega.origem.cidade : '',
      cidadeId: props.entrega.origem ? props.entrega.origem.cidadeId : '',
      estado: props.entrega.origem ? props.entrega.origem.estado : '',
      nomeCliente: props.entrega.origem ? props.entrega.origem.nomeCliente : '',
      telefoneCliente: props.entrega.origem ? props.entrega.origem.telefoneCliente : '',
      favorito: (props.entrega.origem && props.entrega.origem.favorito === true) ? props.entrega.origem.favorito : false,
    }
  }
  ...
  btnNext = async () => {
    ...
    if (this.isFormValid()) {
      ...
      this.props.navigation.navigate('InstructionsPickupAddress');
    } else {
...
export default connect(mapStateToProps, mapDispatchToProps)(InsertPickupAddressPage);