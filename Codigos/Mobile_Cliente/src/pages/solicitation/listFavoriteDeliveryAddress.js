...
class ListFavoriteDeliveryAddressPage extends React.Component {
  state = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ListFavoriteDeliveryAddressPage);