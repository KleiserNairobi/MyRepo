        ...
        <ImageBackground source={sourceBackground} style={{ flex: 1 }} imageStyle={{ width:'100%', height: '50%', resizeMode: 'stretch', top: undefined }}>
          ...
          <View style={Styles.contentContainer}>
            <View style={Styles.textBox}>
              ...
              <Text style={Styles.fontBoxDefault}>NOSSA EQUIPE ESTÁ TRABALHANDO PARA VERIFICAR OS DADOS ENVIADOS</Text>
              <Text style={Styles.fontBoxDefault}>E EM BREVE SEU CADASTRO ESTARÁ LIBERADO</Text>
            </View>
            <TouchableOpacity
              style={Styles.largeButton}
              onPress={this.btnNext}>
              <Text style={Styles.textButton}>IR PARA TELA DE ACESSO</Text>
            </TouchableOpacity>
          </View>
        </ImageBackground>
      </View>
