...
class RegisterPfPage extends ValidationComponent {
  constructor(props) {
    super(props);
    this.errors = [];
        ...
        <KeyboardAvoidingView style={Styles.body}>
          ...
          <View style={Styles.contentContainer}>
            <View style={Styles.textBox}>
              ...
              <Text style={Styles.fontBoxDefault}>OS SEGUINTES DADOS PESSOAS:</Text>
            </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(RegisterPfPage);